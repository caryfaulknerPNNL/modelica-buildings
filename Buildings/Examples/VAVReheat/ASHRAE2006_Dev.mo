...
equation
  connect(hvac.y_on_off, flo.u_on_off) annotation (Line(points={{43.375,
          -24.3889},{48,-24.3889},{48,-2},{46,-2},{46,38},{24,38},{24,36},{12,
          36},{12,45.2308},{18.1739,45.2308}}, color={255,0,255}));
  annotation (
