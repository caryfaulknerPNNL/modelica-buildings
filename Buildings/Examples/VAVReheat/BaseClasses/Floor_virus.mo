...
model Floor_virus "Model of a floor of the building"
  extends Buildings.Examples.VAVReheat.BaseClasses.PartialFloor_virus(
  ...
  Buildings.ThermalZones.Detailed.MixedAir_virus eas(
    redeclare package Medium = Medium,
    AFlo=AFloEas,
    hRoo=hRoo,
    nConExt=0,
  ...
  Buildings.ThermalZones.Detailed.MixedAir_virus nor(
    redeclare package Medium = Medium,
    AFlo=AFloNor,
    hRoo=hRoo,
    nConExt=0,
    ...
    annotation (Placement(transformation(extent={{142,116},{182,156}})));
  Buildings.ThermalZones.Detailed.MixedAir_virus wes(
    redeclare package Medium = Medium,
    AFlo=AFloWes,
    hRoo=hRoo,
    nConExt=0,
  ...
  Buildings.ThermalZones.Detailed.MixedAir_virus cor(
    redeclare package Medium = Medium,
    AFlo=AFloCor,
    hRoo=hRoo,
    nConExt=0,
...
equation
  ...
  connect(eas.surf_surBou[2], nor.surf_conBou[1]) annotation (Line(
      points={{320.2,62.5},{320.2,24},{220,24},{220,100},{168,100},{168,119.333}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(nor.surf_conBou[2], cor.surf_surBou[3]) annotation (Line(
      points={{168,120},{168,100},{200,100},{200,26},{160.2,26},{160.2,42.25}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(nor.surf_conBou[3], wes.surf_surBou[1]) annotation (Line(
      points={{168,120.667},{168,100},{60,100},{60,20},{28.2,20},{28.2,41.5}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(replicator.y, nor.uSha) annotation (Line(
      points={{-39,180},{130,180},{130,154},{140.4,154}},
      color={0,0,127},
  ...
  connect(nor.weaBus, weaBus) annotation (Line(
      points={{179.9,153.9},{179.9,168},{210,168},{210,200}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(nor.heaPorAir, temAirNor.port) annotation (Line(
      points={{161,136},{164,136},{164,290},{292,290}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(nor.ports[1], portsNor[1]) annotation (Line(
      points={{147,122.8},{114,122.8},{114,124},{80,124}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(nor.ports[2], portsNor[2]) annotation (Line(
      points={{147,124.4},{124,124.4},{124,124},{100,124}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(leaNor.port_b, nor.ports[3]) annotation (Line(
      points={{-20,320},{138,320},{138,126},{147,126}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(opeNorCor.port_b1, nor.ports[4]) annotation (Line(
      points={{100,90},{124,90},{124,127.6},{147,127.6}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(opeNorCor.port_a2, nor.ports[5]) annotation (Line(
      points={{100,78},{126,78},{126,129.2},{147,129.2}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(uSha.y,replicator. u) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(const1.y, wes.C_flow[1]) annotation (Line(points={{-117,-4},{-72,-4},{
          -72,64},{-16,64},{-16,58.8},{10.4,58.8}}, color={0,0,127}));
  connect(const1.y, sou.C_flow[1]) annotation (Line(points={{-117,-4},{-72,-4},{
          -72,64},{-16,64},{-16,56},{4,56},{4,28},{32,28},{32,24},{140,24},{140,
          -12},{142.4,-12},{142.4,-21.2}}, color={0,0,127}));
  connect(const1.y, cor.C_flow[1]) annotation (Line(points={{-117,-4},{-72,-4},{
          -72,64},{-16,64},{-16,56},{4,56},{4,28},{32,28},{32,24},{124,24},{124,
          58.8},{142.4,58.8}}, color={0,0,127}));
  connect(const1.y, nor.C_flow[1]) annotation (Line(points={{-117,-4},{-72,-4},
          {-72,64},{-16,64},{-16,56},{4,56},{4,28},{32,28},{32,24},{124,24},{
          124,138.8},{140.4,138.8}},
                                 color={0,0,127}));
  connect(const1.y, eas.C_flow[1]) annotation (Line(points={{-117,-4},{-72,-4},{
          -72,64},{-16,64},{-16,56},{4,56},{4,28},{32,28},{32,24},{124,24},{124,
  ...
  connect(u_on_off, wes.u_on_off) annotation (Line(points={{-92,-46},{8,-46},{8,
          32},{10.2,32},{10.2,41.8}}, color={255,0,255}));
  connect(u_on_off, cor.u_on_off) annotation (Line(points={{-92,-46},{8,-46},{8,
          32},{132,32},{132,41.8},{142.2,41.8}}, color={255,0,255}));
  connect(u_on_off, sou.u_on_off) annotation (Line(points={{-92,-46},{-4,-46},{
          -4,-76},{140,-76},{140,-48},{142.2,-48},{142.2,-38.2}}, color={255,0,
          255}));
  connect(u_on_off, nor.u_on_off) annotation (Line(points={{-92,-46},{8,-46},{8,
          32},{132,32},{132,112},{140.2,112},{140.2,121.8}}, color={255,0,255}));
  connect(u_on_off, eas.u_on_off) annotation (Line(points={{-92,-46},{8,-46},{8,
          32},{132,32},{132,112},{268,112},{268,61.8},{302.2,61.8}}, color={255,
          0,255}));
  connect(const2.y, wes.C_flow[2]) annotation (Line(points={{-125,-58},{-112,
          -58},{-112,-20},{-80,-20},{-80,-4},{-72,-4},{-72,64},{-16,64},{-16,
          58.8},{10.4,58.8}}, color={0,0,127}));
  connect(const2.y, nor.C_flow[2]) annotation (Line(points={{-125,-58},{-112,
          -58},{-112,-20},{-80,-20},{-80,-4},{-72,-4},{-72,64},{-16,64},{-16,56},
          {4,56},{4,28},{32,28},{32,24},{124,24},{124,138.8},{140.4,138.8}},
        color={0,0,127}));
  connect(const2.y, eas.C_flow[2]) annotation (Line(points={{-125,-58},{-112,
          -58},{-112,-20},{-80,-20},{-80,-4},{-72,-4},{-72,64},{-16,64},{-16,56},
