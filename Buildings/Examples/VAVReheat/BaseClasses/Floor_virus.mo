...
model Floor_virus "Model of a floor of the building"
  ...
  parameter Real winWalRat(
    max=0.99,
    min=0.01)=0.33   "Window to wall ratio for exterior walls";
...
equation
  ...
  connect(eas.surf_surBou[2], nor.surf_conBou[1]) annotation (Line(
      points={{320.2,62.25},{320.2,24},{220,24},{220,100},{168,100},{168,
          119.667}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(nor.surf_conBou[2], cor.surf_surBou[3]) annotation (Line(
      points={{168,120},{168,100},{200,100},{200,26},{160.2,26},{160.2,42.125}},
      color={191,0,0},
      smooth=Smooth.None));
  ...
  connect(nor.ports[1], portsNor[1]) annotation (Line(
      points={{147,124.4},{114,124.4},{114,124},{85,124}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(nor.ports[2], portsNor[2]) annotation (Line(
      points={{147,125.2},{124,125.2},{124,124},{95,124}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(opeNorCor.port_b1, nor.ports[4]) annotation (Line(
      points={{100,90},{124,90},{124,126.8},{147,126.8}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  connect(opeNorCor.port_a2, nor.ports[5]) annotation (Line(
      points={{100,78},{126,78},{126,127.6},{147,127.6}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
