...
equation
  ...
  connect(TRooAve.u, TRoo) annotation (Line(points={{-342,240},{-360,240},{-360,
          320},{-400,320}}, color={0,0,127}));
  connect(freSta.u, TMix.T) annotation (Line(points={{-62,-80},{-72,-80},{-72,
          -60},{26,-60},{26,-20},{20,-20},{20,-29}},
                                                color={0,0,127}));
  ...
  connect(TRooHeaSet.y, conVAV.TRooHeaSet) annotation (Line(points={{502,64},{
          552,64},{552,56},{582,56}},
                                 color={0,0,127}));
  connect(TRooCooSet.y, conVAV.TRooCooSet) annotation (Line(points={{502,30},{
          544,30},{544,50},{582,50}},
                                 color={0,0,127}));
  connect(conVAV.yDam, VAVBox.yVAV)
    annotation (Line(points={{605,54.8},{716,56}}, color={0,0,127}));
  connect(conVAV.yVal, VAVBox.yHea) annotation (Line(points={{605,45},{608,45},
          {608,46},{716,46}}, color={0,0,127}));
  connect(modeSelector.yFan, y_on_off) annotation (Line(points={{-179.091,
          -305.455},{16,-305.455},{16,-328},{408,-328},{408,-114},{450,-114}},
        color={255,0,255}));
  connect(modeSelector.yFan, conVAV[1].uFan) annotation (Line(points={{-179.091,
          -305.455},{-179.091,60},{582,60}}, color={255,0,255}));
  connect(modeSelector.yFan, conVAV[2].uFan) annotation (Line(points={{-179.091,
          -305.455},{16,-305.455},{16,-328},{408,-328},{408,-56},{432,-56},{432,
          104},{568,104},{568,80},{582,80},{582,60}}, color={255,0,255}));
  connect(modeSelector.yFan, conVAV[3].uFan) annotation (Line(points={{-179.091,
          -305.455},{-179.091,60},{582,60}}, color={255,0,255}));
  connect(modeSelector.yFan, conVAV[4].uFan) annotation (Line(points={{-179.091,
          -305.455},{16,-305.455},{16,-328},{408,-328},{408,-56},{432,-56},{432,
          104},{568,104},{568,80},{582,80},{582,60}}, color={255,0,255}));
  connect(modeSelector.yFan, conVAV[5].uFan) annotation (Line(points={{-179.091,
          -305.455},{16,-305.455},{16,-328},{408,-328},{408,-56},{432,-56},{432,
          104},{568,104},{568,80},{582,80},{582,60}}, color={255,0,255}));
  connect(senRelHumRet.phi, conTSup.RelHum) annotation (Line(points={{229.9,151},
          {-62,151},{-62,-211}}, color={0,0,127}));
  annotation (
