...
model DataCenterContinuousTimeControl_test_io_weather
  ...
  extends Buildings.Examples.ChillerPlant.BaseClasses.DataCenter(
    ...
    break connect(wseCon.TWetBul, weaBus.TWetBul),
    break connect(cooTow.TAir, weaBus.TWetBul));
  ...
  Modelica.Blocks.Interfaces.RealInput u_TWetBul
    annotation (Placement(transformation(extent={{-440,180},{-400,220}})));
equation
  ...
  connect(u_CWST, conPID.u_m) annotation (Line(points={{-420,140},{-204,140},{
        ...
        color={0,0,127}));
  connect(u_TWetBul, wseCon.TWetBul) annotation (Line(points={{-420,200},{-192,
          200},{-192,-24},{-188,-24},{-188,-28.4118},{-162,-28.4118}}, color={0,
          0,127}));
  connect(u_TWetBul, cooTow.TAir) annotation (Line(points={{-420,200},{-172,200},
          {-172,220},{96,220},{96,243},{257,243}}, color={0,0,127}));
  annotation (
...
end DataCenterContinuousTimeControl_test_io_weather;
