<<<<<<< HEAD:Buildings/Fluid/HeatExchangers/DXCoils/BaseClasses/CoolingCapacityAirCooled.mo
...
block CapacityAirSource
  ...
  extends Buildings.Fluid.DXSystems.Cooling.BaseClasses.PartialCapacity(
    use_mCon_flow=false);
>>>>>>> origin/issue3720_air_cleaning:Buildings/Fluid/DXSystems/BaseClasses/CapacityAirSource.mo
