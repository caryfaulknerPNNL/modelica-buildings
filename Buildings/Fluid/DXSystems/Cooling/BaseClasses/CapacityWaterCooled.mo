<<<<<<< HEAD:Buildings/Fluid/HeatExchangers/DXCoils/BaseClasses/CoolingCapacityWaterCooled.mo
...
>>>>>>> origin/issue3720_air_cleaning:Buildings/Fluid/DXSystems/Cooling/BaseClasses/CapacityWaterCooled.mo
  extends
    Buildings.Fluid.DXSystems.Cooling.BaseClasses.PartialCapacity(
  final use_mCon_flow=true,
  redeclare Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.BaseClasses.Stage sta[nSta]);
