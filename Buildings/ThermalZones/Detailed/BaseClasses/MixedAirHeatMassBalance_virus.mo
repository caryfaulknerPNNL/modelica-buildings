...
equation
  ...
  connect(senRelHum3.port, ports[2]) annotation (Line(points={{-40,-162},{-40,-238},
          {-8,-238}},        color={0,127,255}));
  connect(senRelHum4.port, ports[3]) annotation (Line(points={{0,-166},{0,-178},
          {-22,-178},{-22,-216},{-26,-216},{-26,-222},{0,-222},{0,-238}}, color=
         {0,127,255}));
  connect(senRelHum2.port, ports[4]) annotation (Line(points={{10,-136},{10,-142},
          {16,-142},{16,-148},{18,-148},{18,-178},{-22,-178},{-22,-216},{-26,-216},
          {-26,-222},{8,-222},{8,-238}},             color={0,127,255}));
