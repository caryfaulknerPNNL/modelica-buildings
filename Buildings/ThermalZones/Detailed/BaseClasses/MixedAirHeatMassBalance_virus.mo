...
model MixedAirHeatMassBalance_virus
  ...
  Fluid.Sensors.RelativeHumidity senRelHum1(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-20,-106},{0,-86}})));
  Fluid.Sensors.RelativeHumidity senRelHum2(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{0,-136},{20,-116}})));
  Fluid.Sensors.RelativeHumidity senRelHum3(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{-50,-162},{-30,-142}})));
  Fluid.Sensors.RelativeHumidity senRelHum4(redeclare package Medium = Medium)
...
equation
  ...
  connect(virConc.y, gUV.C) annotation (Line(points={{-145,-34},{-114,-34},{
          -114,14},{-112,14},{-112,28},{-102,28}},
                                              color={0,0,127}));
  connect(gUV.diss, vol.heatPort) annotation (Line(points={{-79.6,16},{20,16},{20,
          -78},{22,-78},{22,-82},{20,-82},{20,-200},{10,-200}}, color={191,0,0}));
  connect(gUV.yC_flow, add1.u1) annotation (Line(points={{-79,28},{-66,28},{-66,
          -22},{-14,-22},{-14,-24},{-16,-24}}, color={0,0,127}));
  connect(add.y, add1.u2) annotation (Line(points={{-31,-44},{-24,-44},{-24,-36},
          {-16,-36}}, color={0,0,127}));
  connect(u_on_off, pAC.u) annotation (Line(points={{-260,-40},{-158,-40},{-158,
          38},{-58,38}},          color={255,0,255}));
  connect(virConc.y, pAC.C) annotation (Line(points={{-145,-34},{-126,-34},{
          -126,14},{-124,14},{-124,44},{-58,44}},
                                             color={0,0,127}));
  connect(pAC.diss, vol.heatPort) annotation (Line(points={{-35.6,32},{20,32},{20,
          2},{22,2},{22,-2},{20,-2},{20,-200},{10,-200}}, color={191,0,0}));
  connect(pAC.yC_flow, add2.u1)
  ...
  connect(ports[1], senRelHum.port) annotation (Line(points={{-32,-238},{-32,
          -216},{-22,-216},{-22,-144},{-26,-144},{-26,-138}},
                                                       color={0,127,255}));
  connect(senRelHum3.port, ports[2]) annotation (Line(points={{-40,-162},{-40,
          -238},{-16,-238}}, color={0,127,255}));
  connect(senRelHum4.port, ports[3]) annotation (Line(points={{0,-166},{0,-178},
          {-22,-178},{-22,-216},{-26,-216},{-26,-222},{0,-222},{0,-238}}, color=
         {0,127,255}));
  connect(senRelHum2.port, ports[4]) annotation (Line(points={{10,-136},{10,
          -142},{16,-142},{16,-148},{18,-148},{18,-178},{-22,-178},{-22,-216},{
          -26,-216},{-26,-222},{16,-222},{16,-238}}, color={0,127,255}));
  connect(senRelHum1.port, ports[5]) annotation (Line(points={{-10,-106},{-10,
          -120},{-8,-120},{-8,-144},{-22,-144},{-22,-216},{-26,-216},{-26,-222},
          {32,-222},{32,-238}}, color={0,127,255}));
  annotation (
...
end MixedAirHeatMassBalance_virus;
