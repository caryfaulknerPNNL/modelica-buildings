...
model MixedAir_virus
  ...
  redeclare Buildings.ThermalZones.Detailed.BaseClasses.MixedAirHeatMassBalance_virus air(
  ...
  Modelica.Blocks.Interfaces.BooleanInput u_on_off annotation (Placement(
        transformation(extent={{-238,-162},{-198,-122}}), iconTransformation(
          extent={{-238,-162},{-198,-122}})));
equation
  ...
  connect(C_flow, air.C_flow) annotation (Line(points={{-280,-110},{-200,-110},{
        ...
        color={0,0,127}));
  connect(u_on_off, air.u_on_off) annotation (Line(points={{-218,-142},{-144,
          -142},{-144,-132},{39,-132}}, color={255,0,255}));
  annotation (
