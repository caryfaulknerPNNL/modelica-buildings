...
block AirEconomizerHighLimits "Specify the economizer high liimits"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch swi4 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch swi8 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{360,-590},{380,-570}})));
  Buildings.Controls.OBC.CDL.Logical.And and8 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-660},{220,-640}})));
  Buildings.Controls.OBC.CDL.Continuous.Switch swi9 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{480,-640},{500,-620}})));
  Buildings.Controls.OBC.CDL.Logical.And and9 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
    annotation (Placement(transformation(extent={{200,-740},{220,-720}})));
  Buildings.Controls.OBC.CDL.Continuous.Switch swi10 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch swi11 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{400,-820},{420,-800}})));
  Buildings.Controls.OBC.CDL.Logical.And and10 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical and"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch swi12 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Cut off outdoor air temperature"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant titEngSta(
    final k=eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24) if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Check if Title 24 energy standard is used"
    annotation (Placement(transformation(extent={{-460,-720},{-440,-700}})));
  Buildings.Controls.OBC.CDL.Logical.And and11 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
  ...
  Buildings.Controls.OBC.CDL.Logical.Not not2 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.California_Title_24
    "Logical not"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con11(
    final k=0) if
       not (ecoHigLimCon == Buildings.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialDryBulb
     or ecoHigLimCon == Buildings.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedDryBulbWithDifferentialDryBulb)
    "Constant 0"
  ...
  Buildings.Controls.OBC.CDL.Logical.And and12 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,270},{240,290}})));
  Buildings.Controls.OBC.CDL.Continuous.Min min1 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Smaller input"
    annotation (Placement(transformation(extent={{220,310},{240,330}})));
  Buildings.Controls.OBC.CDL.Continuous.Switch swi13 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{300,270},{320,290}})));
  Buildings.Controls.OBC.CDL.Logical.And and13 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,180},{240,200}})));
  Buildings.Controls.OBC.CDL.Continuous.Min min2 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Smaller input"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch swi14 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Cut off outdoor air temperature"
    annotation (Placement(transformation(extent={{260,180},{280,200}})));
  Buildings.Controls.OBC.CDL.Logical.And and14 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical and"
    annotation (Placement(transformation(extent={{220,120},{240,140}})));
  Buildings.Controls.OBC.CDL.Logical.Not not3 if
       eneStd == Buildings.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1
    "Logical not"
