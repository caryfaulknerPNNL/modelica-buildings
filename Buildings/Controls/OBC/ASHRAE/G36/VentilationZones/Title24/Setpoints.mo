...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(final p=-200) if
       have_CO2Sen
  ...
  Buildings.Controls.OBC.CDL.Continuous.Line zonOccMin2 if
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant one2(final k=1) if
       not have_CO2Sen "Constant one"
    annotation (Placement(transformation(extent={{-80,-270},{-60,-250}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zer3(final k=0) if
       not have_CO2Sen
    "Constant zero"
