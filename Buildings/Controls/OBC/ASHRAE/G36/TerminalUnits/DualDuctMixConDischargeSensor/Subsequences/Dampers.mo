...
equation
  ...
  connect(gai.y, cooDamPos.u3) annotation (Line(points={{202,110},{260,110},{260,
  ...
  connect(VDisSet_flowNor1.y, gai1.u) annotation (Line(points={{142,-170},{160,-170},
          {160,-240},{178,-240}}, color={0,0,127}));
