...
equation
  ...
  connect(VDisSet_flowNor.y, gai.u) annotation (Line(points={{242,170},{250,170},
          {250,90},{160,90},{160,-10},{178,-10}}, color={0,0,127}));
  connect(gai.y, swi3.u3) annotation (Line(points={{202,-10},{220,-10},{220,12},
          {238,12}}, color={0,0,127}));
