...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter uSetWd(final k=wd) if
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter divK(final k=1/k) if
       reset <> Buildings.Obsolete.Controls.OBC.CDL.Types.Reset.Disabled
