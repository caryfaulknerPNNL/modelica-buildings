...
model inDucGUVExample
  ...
  //parameter Modelica.Units.SI.MassFlowRate m_flow_small = 1e-3
...
equation
  connect(flo.ports[1], inDucGUV.port_a)
    annotation (Line(points={{-28,0},{-10,0}}, color={0,127,255}));
  connect(onSig.y, inDucGUV.u) annotation (Line(points={{-45,-40},{-20,-40},{-20,
          -8},{-12,-8}}, color={255,0,255}));
  connect(ramFlo.y, flo.m_flow_in) annotation (Line(points={{-69,30},{-58,30},{-58,
          8},{-50,8}}, color={0,0,127}));
  connect(inDucGUV.port_b, vol.ports[1]) annotation (Line(points={{10,0},{50,0},
