...
equation
  connect(const.y, vol.mWat_flow) annotation (Line(points={{-41,32},{-22,32},{
          -22,10},{6,10}},
                       color={0,0,127}));
  connect(patConc.y, pAC.C) annotation (Line(points={{-69,-30},{-44,-30},{-44,
          -48},{-38,-48}},
                      color={0,0,127}));
  connect(const.y, vol.C_flow[1]) annotation (Line(points={{-41,32},{-22,32},{
          -22,10},{0,10},{0,-4},{6,-4}},
                         color={0,0,127}));
  ...
  connect(viralDecay.y, vol.C_flow[2]) annotation (Line(points={{-15,-80},{0,
          -80},{0,-10},{2,-10},{2,-4},{6,-4}}, color={0,0,127}));
  connect(pAC.yC_flow, vol.C_flow[2]) annotation (Line(points={{-15,-48},{0,-48},
          {0,-10},{2,-10},{2,-4},{6,-4}}, color={0,0,127}));
  annotation (
